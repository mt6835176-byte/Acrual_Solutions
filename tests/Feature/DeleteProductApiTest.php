...
class DeleteProductApiTest extends TestCase
{
    ...
    public function test_can_delete_existing_product(): void
    {
        ...
        $response = $this->deleteJson('/api/products/' . $product['id'], [], ['Accept' => 'application/json']);
    ...
    {
        $response = $this->deleteJson('/api/products/nonexistent-uuid', [], ['Accept' => 'application/json']);
